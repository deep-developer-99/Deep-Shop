const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      >
        Deepanshu Rawat (@deepanshu_rawat)
      </h3>
      ...
      >
        <a
          href="https://deep-developer-99.github.io/Deepanshu-Portfolio/"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://instagram.com/hey.deep_"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
        ...
        <a
          href="https://linkedin.com/in/deepanshu-rawat-69b795261"
          target="_blank"
          rel="noreferrer"
          style={{
            ...socialBtnStyle,
