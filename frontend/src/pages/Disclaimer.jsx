  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: "20px" }}>
        ...
        DeepShop domain strictly act uniquely as an educational development
      ...
      <p style={{ marginBottom: "15px" }}>
        The materials spanning the Deepshop interface may heavily include
      ...
      <p style={{ marginBottom: "15px" }}>
        Deepshop operates completely independent domains and takes strictly zero
